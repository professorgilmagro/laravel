...
@if (Session::has('message'))
    <div class="alert alert-{{ Session::get('msgType') }}">{{ Session::get('message') }}</div>
@endif

{{ Form::open(['route' => 'usuario.signin', 'class' => 'form-signin']) }}
        ...
        <div style="padding-top:30px" class="panel-body" >
            ...
            <form id="loginform" class="form-horizontal" role="form">
                ...
                <div style="margin-bottom: 25px" class="input-group">
                            ...
                            <input id="login-email" type="email" class="form-control" name="email" value="" placeholder="E-mail">
                        </div>
